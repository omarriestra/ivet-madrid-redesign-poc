              ...
              <ul className="mt-5 space-y-5">
                {clinics.map((clinic) => (
                  <li key={clinic.slug} className="border-b border-bone-200 pb-5 last:border-0 last:pb-0">
                    <p className="font-serif font-semibold text-petrol-900">
                      {clinic.name}
                    </p>
                    <p className="mt-1.5 flex items-start gap-2 text-sm text-petrol-800/70">
                    ...
                    <div className="mt-3 flex flex-wrap gap-x-4 gap-y-2 text-sm">
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 font-medium tabular-nums text-petrol-700 hover:text-petrol-500"
                      >
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-petrol-700 hover:text-petrol-500"
                      >
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 break-all text-petrol-700 hover:text-petrol-500"
                      >
